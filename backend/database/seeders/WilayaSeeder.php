...
class WilayaSeeder extends Seeder
{
    public function run(): void
    {
        $wilayas = [
            ...
            ['code' => 60, 'name' => 'El Abiodh Sidi Cheikh', 'name_ar' => 'الأبيض سيدي الشيخ'],
            ['code' => 61, 'name' => 'El Aricha', 'name_ar' => 'العريشة'],
            ['code' => 62, 'name' => 'El Kantara', 'name_ar' => 'القنطرة'],
            ['code' => 63, 'name' => 'Barika', 'name_ar' => 'بريكة'],
            ['code' => 64, 'name' => 'Bou Saâda', 'name_ar' => 'بوسعادة'],
            ['code' => 65, 'name' => 'Bir El Ater', 'name_ar' => 'بئر العاتر'],
            ['code' => 66, 'name' => 'Ksar El Boukhari', 'name_ar' => 'قصر البخاري'],
            ['code' => 67, 'name' => 'Ksar Chellala', 'name_ar' => 'قصر الشلالة'],
            ['code' => 68, 'name' => 'Aïn Oussara', 'name_ar' => 'عين وسارة'],
            ['code' => 69, 'name' => 'M\'saâd', 'name_ar' => 'مسعد'],
        ];

        foreach ($wilayas as $wilaya) {
            Wilaya::updateOrCreate(['code' => $wilaya['code']], $wilaya);
        }
    }
}
